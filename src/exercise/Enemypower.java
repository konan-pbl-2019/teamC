...
public class Enemypower extends BasePeople {
	...
	public Enemypower(Sprite fimage, Vector2 fsize, float fradian, Vector2 fposition, ExerciseGame fexerciseGame) {
		super(fimage, fsize, fradian, fposition);
		super.SetController(new EnemyController());
		super.SetParameter(new ActorParameter(10, 10, 30, 10, 10));
